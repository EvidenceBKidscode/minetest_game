...
minetest.register_node("flowers:mushroom_red", {
	...
	walkable = false,
	buildable_to = true,
	groups = {mushroom = 1, snappy = 3, attached_node = 1, flammable = 1, decoration = 1},
	sounds = default.node_sound_leaves_defaults(),
...
minetest.register_node("flowers:mushroom_brown", {
	...
	walkable = false,
	buildable_to = true,
	groups = {mushroom = 1, food_mushroom = 1, snappy = 3, attached_node = 1, flammable = 1, decoration = 1},
	sounds = default.node_sound_leaves_defaults(),
...
local waterlily_def = {
	...
	buildable_to = true,
	floodable = true,
	groups = {snappy = 3, flower = 1, flammable = 1, decoration = 1},
	sounds = default.node_sound_leaves_defaults(),
