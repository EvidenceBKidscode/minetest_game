...
doors.register("door_wood", {
		...
		groups = {node = 1, choppy = 2, level = 3, flammable = 2, decoration = 1, interactive = 1},
		recipe = {
...
doors.register("door_steel", {
		...
		protected = true,
		groups = {node = 1, cracky = 1, level = 2, decoration = 1, interactive = 1},
...
doors.register("door_glass", {
		...
		groups = {node = 1, cracky=3, oddly_breakable_by_hand=3, decoration = 1, interactive = 1},
...
doors.register("door_obsidian_glass", {
		...
		groups = {node = 1, cracky=3, decoration = 1, interactive = 1},
		sounds = default.node_sound_glass_defaults(),
		sound_open = "doors_glass_door_open",
		sound_close = "doors_glass_door_close",
		recipe = {
